...
//obteniendo elementos del document:
  ...
  function play() { //Funcion para la ejecucion de los turnos
        ...
        if (game === true) {
            ...
            validate();
            game = false; } //pasa al siguiente jugador
  }
  ...
  function validate(){ //Funcion que valida si hay un ganador o empate:
                   ...
                   if((b1.value == "X" && b2.value == "X" && b3.value == "X") ||
                      ...
                      {alert("Jugador X ganó!!");} //si hay 3 X seguidas gana X
                      ...
                      {alert("Jugador O ganó!!");} //si hay 3 O seguidas gana O
                      ...
                      {alert("Es un empate!!");} //Si no hay casillas disponibles es empate.
  }
